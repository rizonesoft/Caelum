...
This guide walks you through obtaining and configuring a Gemini API key for **Caelum**.

## 1. Create a Google Cloud Project

1. Go to the [Google Cloud Console](https://console.cloud.google.com)
2. Click **Select a Project** → **New Project**
3. Name it **Caelum** (or any name you prefer)
4. Click **Create**
